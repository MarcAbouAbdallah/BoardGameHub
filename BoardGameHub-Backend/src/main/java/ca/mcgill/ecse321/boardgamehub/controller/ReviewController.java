...
public class ReviewController {
    ...
    public void deleteReview(@PathVariable int reviewId, @RequestParam int reviewerId) {
    ...
    public ReviewResponseDto editReview(@PathVariable int reviewId, @RequestParam int reviewerId, @RequestBody ReviewUpdateDto editedReview) {
        Review changedReview = reviewService.editReview(reviewId, reviewerId, editedReview);
