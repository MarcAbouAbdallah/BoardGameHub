...
public class ReviewController {
    ...
    public ReviewResponseDto editReview(@PathVariable int id, @RequestBody ReviewUpdateDto editedReview) {
        Review changedReview = reviewService.editReview(id, editedReview);
