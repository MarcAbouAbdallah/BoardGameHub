...
|Jerome Courtemanche||||
|Bora Denizasan||||
|Mubeen Mohammed|Developer|Implemented the PlayerService and PlayerController along with their respective unit and integration test. Reviewed other teamates pull request and contributed to project documentation|~15h|
