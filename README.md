...
|Deon Aftahi||||
|Marleine Atalla||||
|Jerome Courtemanche|Written report director, developper|Setting up the repository, implementing the "Review" class, persistence and tests and documenting the README.md & wiki.||
|Bora Denizasan||||
|Mubeen Mohammed||||
|Raphael Verger||||
